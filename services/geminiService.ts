...
export const generateMnemonicData = async (inputWord: string, mode: 'turkish_to_arabic' | 'arabic_to_turkish', modelId: string = DEFAULT_TEXT_MODEL) => {
  ...
  // Adjust system instruction based on mode to be more explicit
  let modeInstruction = "";
