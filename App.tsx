...
export default function App() {
  ...
  const [libraryViewMode, setLibraryViewMode] = useState<'tabs' | 'tree'>(() => 
    (localStorage.getItem('library-view-mode') as 'tabs' | 'tree') || 'tabs'
  );
  ...
  useEffect(() => {
    localStorage.setItem('library-view-mode', libraryViewMode);
  }, [libraryViewMode]);
  ...
  const handleCloseModal = () => {
      ...
      setCardToEdit(null); // Clear edit state on close
  }
